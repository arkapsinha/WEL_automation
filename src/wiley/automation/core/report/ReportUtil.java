...
public class ReportUtil {
	...
	public static void generateHTMLReport(String Status){
		try{
		        ...
		        String renderedHtml = renderer.renderReport(VariableController.getTestCaseName(),VariableController.StartTime,EndTime ,Status, CommonUtil.getBrowser(), tcasestep, status, description, Screenshot,seconds );
