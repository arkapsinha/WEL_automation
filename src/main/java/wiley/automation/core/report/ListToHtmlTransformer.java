...
public class ListToHtmlTransformer {
	...
	public String renderReport(String tesCaseName, String TCDescription, Date Starttime ,Date Endtime,String Status,String browser , java.util.Collection< String >  tcasestep , java.util.Collection< String >  status , java.util.Collection< String >  description , java.util.Collection< String >  Screenshot , long time){
         ...
         html.append( "<html>\n" );
         html.append( "<head>\n" );
         html.append( "<title>HYBRIS Functional Report</title>\n" );
         html.append( "<style>" );
         html.append( "body {margin 0px 0px 0px 0px;	background-image: url('./img/backg.jpg')}\n" );
         ...
         html.append( ".header {font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;font-size: 20px; font-weight: normal; font-style: italic; font-variant: normal; color: #FFFFFF; vertical-align: middle; text-align: center;word-spacing: normal; letter-spacing: normal; width: 100%; height: 10%}\n" );
         ...
         html.append( "<div style='float: right; margin-right: 45px'><img src='./img/welogo.png' /></div>\n" );
         html.append( "<br />\n" );
