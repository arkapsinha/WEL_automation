...
public class HighLevelReportUtil {
	...
	public static void highlevelgenerateHTMLReport(){
		try{
		        ...
		        String renderedHtml = renderer.renderReport(ReportUtil.passed, ReportUtil.failed, ReportUtil.tcases, ReportUtil.tcasesstatus,ReportUtil.tcasesscenario, ReportUtil.browser, ReportUtil.tcasesstarttime, ReportUtil.tcasesendtime);
