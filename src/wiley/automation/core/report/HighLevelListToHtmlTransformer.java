...
public class HighLevelListToHtmlTransformer {
	...
	// static Logger log = Logger.getLogger(HighLevelListToHtmlTransformer.class);
	 ...
	 public String renderReport(int pass,int fail,java.util.Collection< String > tcases, java.util.Collection< String > tcasesstatus,java.util.Collection< String > tcasesscenario,java.util.Collection< String > browser, java.util.Collection< Date> tcasesstarttime, java.util.Collection< Date> tcasesendtime) throws ParseException{   	
		         ...
		         html.append(".maintable {width: 100%; height: 100%; position: fixed;}\n" );
		         ...
		         */
		         ...
		         html.append("<td class='tableheading' width='30%'>Test Case Name</td>\n" );
		         html.append("<td class='tableheading' width='12%'>Status</td>\n" );
		         html.append("<td class='tableheading' width='15%'>Scenario</td>\n" );
		         html.append("<td class='tableheading' width='25%'>Browser</td>\n" );
		         html.append("<td class='tableheading' width='13%'>Execution Time (Sec)</td>\n" );
		         html.append("</tr>\n" );
		         ...
		         html.append("<td class='tablecontent' width='30%'><a target =\"_blank\" name =\"testcase\" href=\"./"+tcases.toArray()[i]+"/"+tcases.toArray()[i]+".html\">"+tcases.toArray()[i]+"&nbsp;</a></td>\n" ); 
		     /*    if(tcasesstatus.toArray()[i].equals("Pass")){
		       ...
		       */  
		         html.append( "<td class= 'tablecontent' align='center' width='12%'>"+tcasesstatus.toArray()[i]+"</td>\n" );
		         ...
		         html.append("<td class='tablecontent' width='25%'>"+browser.toArray()[i]+"&nbsp;</td>\n" );
		         //long seconds = (tcasesendtime.toArray()[k-1]browser.toString()-tcasesstarttime.toArray()[i]).toString()/1000;
		         if(i==0){
		         html.append("<td class='tablecontent' width='13%' rowspan='"+tcases.size()+"'>"+second+"&nbsp;</td>\n");
		         }
		         html.append("</tr>\n" );
		         }
		         html.append("</table>\n" );
