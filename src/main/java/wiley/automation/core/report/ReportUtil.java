...
public class ReportUtil {
	...
	public static void copyFiles(){
		try{
	        ...
	        File dests = new File(Report.getPath()+VariableController.getTestCaseName()+"\\img\\backg.jpg");
	        ...
	        File destsss = new File(Report.getPath()+VariableController.getTestCaseName()+"\\img\\welogo.png");
